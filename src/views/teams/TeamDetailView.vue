      ...
      <template v-else>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-2 space-y-6">
            ...
            <!-- AI Analysis -->
            <div v-if="currentTeam.ai_analysis" class="card">
              ...
              <div class="space-y-4">
                <div>
                  ...
                  <p class="text-gray-600 dark:text-gray-400">{{ currentTeam.ai_analysis.team_dynamics }}</p>
                </div>
                <div>
                  <h3 class="font-medium text-gray-700 dark:text-gray-300 mb-2">強み分布</h3>
                  <p class="text-gray-600 dark:text-gray-400">{{ currentTeam.ai_analysis.strengths_distribution }}</p>
                </div>
                <div>
                  <h3 class="font-medium text-gray-700 dark:text-gray-300 mb-2">潜在的な課題</h3>
                  <p class="text-gray-600 dark:text-gray-400">{{ currentTeam.ai_analysis.potential_challenges }}</p>
                </div>
                <div>
                  <h3 class="font-medium text-gray-700 dark:text-gray-300 mb-2">提案</h3>
                  <p class="text-gray-600 dark:text-gray-400">{{ currentTeam.ai_analysis.recommendations }}</p>
                </div>
              </div>
            </div>
          </div>
                ...
                >
                  ...
                  <div class="ml-3 flex-1 min-w-0">
                    <p class="font-medium text-gray-900 dark:text-white truncate">
                      {{ member.name }}
                      <span
                        v-if="member.id === currentTeam.manager_id"
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 truncate">
                      {{ member.job_title || JOB_TYPE_LABELS[member.job_type || 'other'] }}
                    </p>
                    <!-- Mini strengths -->
