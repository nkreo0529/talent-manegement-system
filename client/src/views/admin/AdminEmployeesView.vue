          ...
          <tbody class="divide-y divide-gray-200 dark:divide-dark-border">
            <tr v-for="emp in filteredEmployees" :key="emp.id" class="hover:bg-gray-50 dark:hover:bg-dark-border">
              ...
              <td class="px-6 py-4 hidden lg:table-cell text-sm text-gray-600 dark:text-gray-400">
                {{ JOB_TYPE_LABELS[emp.jobType || 'other'] }}
              </td>
              ...
              <td class="px-6 py-4">
                <span
                  ...
                  :class="emp.isActive ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600'"
                >
                  {{ emp.isActive ? '有効' : '無効' }}
                </span>
              </td>
        ...
        <div class="bg-white dark:bg-dark-surface rounded-xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
          ...
          <div class="p-6 space-y-4">
            ...
            <div>
              ...
              <select v-model="editingEmployee.jobType" class="input">
            ...
            <div class="flex items-center">
              <input v-model="editingEmployee.isActive" type="checkbox" id="is_active" class="mr-2" />
